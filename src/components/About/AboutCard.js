      ...
      <Card.Body>
        <blockquote className="blockquote mb-0" data-aos="zoom-in" style={{ textAlign: "justify", color: "var(--clr-txt)" }}>
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="primary-header">Sanduni Ekanayake</span> from Negombo, Sri Lanka. I am a Information Technology Undergraduate Student.
            <br />
            <br />
          ...
          <ul>
            ...
            <li className="about-activity">
              <AiOutlineArrowRight /> Reading Novels
            </li>
            <li className="about-activity">
